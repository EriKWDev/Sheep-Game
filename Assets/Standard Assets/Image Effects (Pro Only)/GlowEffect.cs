...
public class GlowEffect : MonoBehaviour
{
	...
	public float blurIterations = 3.0f;
	public float realIntensity = 1.2F;
	...
	void Update() {
		glowIntensity = Mathf.Lerp (glowIntensity, realIntensity, Time.deltaTime);

		glowTint = Color.Lerp (glowTint, newColor, Time.deltaTime);
	}
	...
	void OnRenderImage (RenderTexture source, RenderTexture destination)
	{
		...
		blurIterations = Mathf.Clamp( blurIterations, 0, 35 );
